...
const API_DOCUMENTATION = {
  openapi: "3.0.0",
  info: {
    title: "NeuroLint Pro API",
    version: "1.0.0",
    description:
      "Comprehensive API for NeuroLint Pro - Advanced React/Next.js Code Analysis Platform",
    contact: {
      name: "NeuroLint Pro Support",
  ...
  paths: {
    "/analyze": {
      post: {
        ...
        description: "Analyze React/Next.js code using NeuroLint Pro engine",
        tags: ["Analysis"],
        requestBody: {
          required: true,
          content: {
    ...
    if (format === "html") {
      ...
      const html = `
        ...
        <head>
          ...
          <title>NeuroLint Pro API Documentation</title>
