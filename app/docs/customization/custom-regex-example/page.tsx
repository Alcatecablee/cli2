...
export default function CustomRegexExamplePage() {
      ...
      <div className="relative z-10 container mx-auto px-6 py-16">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Practical examples and patterns for creating powerful regex
            transformations
          </p>
  ...
  fileTypes: ["ts", "tsx", "js", "jsx"]
                    ...
                    <div className="text-gray-300 text-sm">
                      ...
                      <code>https://api.v1.company.com/users</code>
                      <br />
                      <strong>After:</strong>{" "}
                      <code>https://api.v2.company.com/users</code>
                    </div>
                  </div>
  ...
  fileTypes: ["ts", "tsx", "js", "jsx"]
                    ...
                    <div className="text-gray-300 text-sm">
                      <strong>Before:</strong>{" "}
                      <code>process.env.REACT_APP_API_KEY</code>
                      <br />
                      <strong>After:</strong>{" "}
                      <code>process.env.NEXT_PUBLIC_API_KEY</code>
                    </div>
                  </div>
  ...
  fileTypes: ["ts", "tsx"]
                    ...
                    <div className="text-gray-300 text-sm">
                      <strong>Before:</strong>{" "}
                      <code>from '@old-ui/button'</code>
                      <br />
                      <strong>After:</strong>{" "}
                      <code>from '@new-design-system/button'</code>
                    </div>
                  </div>
  ...
  fileTypes: ["tsx", "jsx"]
                    ...
                    <div className="text-gray-300 text-sm">
                      <strong>Before:</strong>{" "}
                      <code>className="btn-primary"</code>
                      <br />
                      <strong>After:</strong>{" "}
                      <code>className="button-primary"</code>
                    </div>
                  </div>
                </div>
              </div>
  ...
  description: "Convert validation string to rules array object"
                    ...
                    <div className="text-gray-300 text-sm mt-3">
                      <strong>Before:</strong>{" "}
                      <code>
                        &lt;Input name="email" validation="required,min:5" /&gt;
                      </code>
                      <br />
                      <strong>After:</strong>{" "}
                      <code>
                        &lt;Input name="email" rules=
  ...
  description: "Migrate useData hook to useQuery with proper destructuring"
                    ...
                    <div className="text-gray-300 text-sm mt-3">
                      <strong>Before:</strong>{" "}
                      <code>const userData = useData('/api/user');</code>
                      <br />
                      <strong>After:</strong>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-gray-300">
                  <li>
                    • Use non-greedy quantifiers (?) when matching nested
                    content
                  </li>
                  <li>
                  ...
                  <li>
                    • Use non-capturing groups (?:) when you don't need the
                    capture
                  </li>
                  <li>• Test patterns with multiline and edge case content</li>
                  <li>
                    • Consider using word boundaries (\b) for exact matches
                  </li>
                </ul>
              </div>
              <div className="space-y-4">
