...
export default function ProductCard({ product, onAddToCart }) {
  ...
  return (
    <div className="product-card" onClick={handleClick}>
      ...
      description: "Component with missing key props and accessibility issues",
    },
    {
      name: "SSR Hydration Problems",
...
export default function UserProfile({ userId }) {
  ...
  return (
    <div className="user-profile">
      ...
      description: "SSR issues with window object and hydration mismatches",
    },
    {
...
export default function BlogPost({ post }) {
  ...
  return (
    <article className="blog-post">
      ...
      description: "Next.js specific patterns and security considerations",
    },
  ];
    ...
    <div className="code-analysis-root">
      ...
      <div className="analysis-header">
        <div className="header-title">
          <h2>Code Analysis Studio</h2>
          <p>
            Upload, paste, or drag files to analyze React/Next.js code quality
          </p>
        </div>
