...
program
    ...
    console.log();
    console.log(chalk_1.default.white("Layer System:"));
    console.log(chalk_1.default.gray("  Layer 1: Configuration validation (tsconfig, package.json)"));
    console.log(chalk_1.default.gray("  Layer 2: Pattern & entity fixes (HTML entities, patterns)"));
    console.log(chalk_1.default.gray("  Layer 3: Component best practices (React keys, accessibility)"));
    console.log(chalk_1.default.gray("  Layer 4: Hydration & SSR protection"));
    console.log(chalk_1.default.gray("  Layer 5: Next.js optimizations (App Router patterns)"));
    console.log(chalk_1.default.gray("  Layer 6: Quality & performance (error handling)"));
    console.log();
    console.log(chalk_1.default.cyan("For more information, visit: https://neurolint.dev/docs"));
});
