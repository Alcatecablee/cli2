...
const patterns = [
  // Fix HTML entity corruption - COMPREHENSIVE SET
  {
  ...
  {
    name: "HTML Entity Less Than",
    pattern: /&lt;/g,
    replacement: "<",
    fileTypes: ["ts", "tsx", "js", "jsx"],
  },
  {
    name: "HTML Entity Greater Than",
    pattern: /&gt;/g,
    replacement: ">",
    fileTypes: ["ts", "tsx", "js", "jsx"],
  },
  {
    name: "HTML Entity Copyright",
    pattern: /&copy;/g,
    replacement: "©",
    fileTypes: ["ts", "tsx", "js", "jsx"],
  },
  {
    name: "HTML Entity En Dash",
    pattern: /&ndash;/g,
    replacement: "–",
    fileTypes: ["ts", "tsx", "js", "jsx"],
  },
  ...
  {
    name: "HTML Entity Dollar Sign (Numeric)",
    pattern: /&#36;/g,
    replacement: "$",
    fileTypes: ["ts", "tsx", "js", "jsx"],
  },
  {
    name: "HTML Entity Dollar Sign (Encoded)",
    pattern: /&amp;#36;/g,
    replacement: "$",
    fileTypes: ["ts", "tsx", "js", "jsx"],
  },
  {
    name: "HTML Entity Non-Breaking Space",
    pattern: /&nbsp;/g,
    replacement: " ",
    fileTypes: ["ts", "tsx", "js", "jsx"],
  },
  {
    name: "HTML Entity Section Sign",
    pattern: /&sect;/g,
    replacement: "§",
    fileTypes: ["ts", "tsx", "js", "jsx"],
  },
  {
    name: "HTML Entity Paragraph Sign",
    pattern: /&para;/g,
    replacement: "¶",
    fileTypes: ["ts", "tsx", "js", "jsx"],
  },
  {
    name: "HTML Entity Bullet",
    pattern: /&bull;/g,
    replacement: "•",
    fileTypes: ["ts", "tsx", "js", "jsx"],
  },
  {
    name: "HTML Entity Degree Sign",
    pattern: /&deg;/g,
    replacement: "°",
    fileTypes: ["ts", "tsx", "js", "jsx"],
  },
  {
    name: "HTML Entity Trademark",
    pattern: /&trade;/g,
    replacement: "™",
    fileTypes: ["ts", "tsx", "js", "jsx"],
  },
